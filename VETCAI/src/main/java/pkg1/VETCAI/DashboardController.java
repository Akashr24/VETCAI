...
public class DashboardController {
    ...
    public List<Map<String, Object>> getSummary() {
        ...
        return districtRepo.findAll().stream().map(d -> {
            ...
            double avgUsage = data.stream().mapToDouble(u -> u.getPowerUsage() == null ? 0.0 : u.getPowerUsage()).average().orElse(0.0);
            double avgCost = data.stream().mapToDouble(u -> u.getCost() == null ? 0.0 : u.getCost()).average().orElse(0.0);
